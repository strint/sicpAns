...
# Answer
* 将之前的scheme-number包改成了real包和integer包
* raise方法现在使用的是直接从op-type-table中get的方法实现的泛型, 也可以通过apply-generic来实现
...
## Running
```
1 ]=> (load "2083_generic_arithmetic_system_coercion_raise.scm")

;Loading "2083_generic_arithmetic_system_coercion_raise.scm"... done
;Value: i2
...
;Value 20: (rational 4 . 1)

1 ]=> r1

;Value 21: (rational 1 . 2)
...
;Value 24: (complex rectangular 4.5 . 0)
```
