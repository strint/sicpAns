...
## Running
```
1 ]=> (load "2080_generic_arithmetic_system_equal_zero.scm")

;Loading "2080_generic_arithmetic_system_equal_zero.scm"... done
;Value: =zero?

1 ]=> (define c (make-complex-from-real-imag 0 0))

;Value: c

1 ]=> c

;Value 16: (complex rectangular 0 . 0)

1 ]=> (=zero? c)

;Value: #t

1 ]=> (define c1 (make-complex-from-real-imag 1 2))

;Value: c1

1 ]=> c1

;Value 11: (complex rectangular 1 . 2)

1 ]=> (=zero? c1)

;Value: #f

1 ]=> (define s (make-scheme-number 0))
...
1 ]=> (define s1 (make-scheme-number 4))
...
1 ]=> (define r (make-rational 0 3))

;Value: r

1 ]=> r

;Value 17: (rational 0 . 1)
;Notic (make-rational 0 3) make (rational 0 . 1), because (gcd 0 3) is 3

1 ]=> (=zero? r)

;Value: #t

1 ]=> (define r1 (make-rational 6 7))

;Value: r1

1 ]=> r1

;Value 13: (rational 6 . 7)
