...
## Running
```
1 ]=> (load "2079_generic_arithmetic_system_equality_predicate.scm")

;Loading "2079_generic_arithmetic_system_equality_predicate.scm"... done
;Value: equ?
...
1 ]=> (define c2 (make-complex-from-real-imag 2 3))

;Value: c2

1 ]=> c2

;Value 12: (complex rectangular 2 . 3)
...
1 ]=> (define s2 (make-scheme-number 5))
...
1 ]=> (define r2 (make-rational 8 9))

;Value: r2

1 ]=> r2

;Value 14: (rational 8 . 9)
