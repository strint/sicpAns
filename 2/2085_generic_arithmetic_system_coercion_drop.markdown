...
# Answer
On the base code of 2084:
* Add 'project' procedures
* Add 'drop' procedure
* Add test case c3, c4
* Add 'drop' to 'apply-generic' procedure to simply its answer
...
## Running
```
1 ]=> (load "2085_generic_arithmetic_system_coercion_drop.scm")

;Loading "2085_generic_arithmetic_system_coercion_drop.scm"... done
;Value: i2

1 ]=> c3

;Value 29: (complex rectangular 2 . 0)
...
;Value 32: (complex rectangular 2.1 . 0)
