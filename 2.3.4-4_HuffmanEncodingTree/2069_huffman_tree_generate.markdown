...
## Running
```
1 ]=> (generate-huffman-tree sample-pairs)

;Value 15: ((leaf a 4) ((leaf b 2) ((leaf c 1) (leaf d 1) (c d) 2) (b c d) 4) (a b c d) 8)

1 ]=> sample-tree

;Value 16: ((leaf a 4) ((leaf b 2) ((leaf d 1) (leaf c 1) (d c) 2) (b d c) 4) (a b d c) 8)
```
